...
### [我的博客在这里 &rarr;](http://fengzhao.github.io)
...
* 你可以自由的fork。页面模板来自[黄玄](http://huangxuan.me)。如果你能将主题作者和 github 的地址保留在你的页面底部，作者将非常感谢你。
* 如果你喜欢这个博客模板，请在`huxpro.github.io`这个repository点个赞——右上角**star**一下。
...
```
# Site settings
title: FengZhao Blog             # 你的博客网站标题
SEOTitle: FengZhao Blog			# 在后面会详细谈到
description: "Cool Blog"    # 随便说点，描述一下

# SNS settings      
github_username: fengzhao     # 你的github账号
...
要发表的文章一般以markdown的格式放在这里`_posts/`，你只要看看这篇模板里的文章你就明白该如何设置。
...
我的博客标题是 **“FengZhao Blog”** 但是我想要在搜索的时候显示 **“冯钊的博客 | Fenga Blog”** ，这个就需要SEO Title来定义了。
